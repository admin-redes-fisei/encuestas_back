...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($datos['tab_codigo']) && isset($datos['tab_formulario_pertenece'])) {
        $tab_codigo = $datos['tab_codigo'];
        $tab_formulario_pertenece = $datos['tab_formulario_pertenece'];
        ...
        if ($existe > 0) {
            ...
            $consulta = $pdo->prepare("INSERT INTO tableros (tab_codigo, tab_formulario_pertenece, tab_fecha_modificacion) 
                                       VALUES (:tab_codigo, :tab_formulario_pertenece, NOW())");
        }
